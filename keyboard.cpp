...
void CKeyBoard::Render()
{
	...
	ImVec2 vecButSize = ImVec2(ImGui::CalcTextSize("QWERTYU").x, ImGui::CalcTextSize("QWERT").x);
	
	ImGui::SetNextWindowPos(ImVec2(io.DisplaySize.x / 1.0135 - vecButSize.x, io.DisplaySize.y / 2.0 - vecButSize.y * 3.0));
